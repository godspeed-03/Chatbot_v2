          ...
          <div className="flex items-center h-screen w-full">
            <div className="w-full bg-white rounded shadow-lg p-8 m-4 md:max-w-sm md:mx-auto">
              ...
              onChange={(e) => setPassword(e.target.value)}
                ...
                <button type="submit" className="bg-green-500 hover:bg-green-700 text-white uppercase text-sm font-semibold px-4 py-2 rounded">
                  Login
                </button>
              </form>
              <Link className=" text-blue-700 text-center text-sm" to="/signup">Sign up</Link>
              <Outlet />
            </div>
          </div>
    </>
